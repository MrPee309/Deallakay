...
import { MapPin, Calendar, Star, ShieldCheck, Wrench, Loader2 } from "lucide-react";
...
export default function TechnicianProfile() {
  ...
  const load = async () => {
    try {
      const [t, r] = await Promise.all([api.get(`/technicians/${username}`), api.get(`/technicians/${username}/reviews`)]);
      setD(t.data); setReviews(r.data);
